...
import { User, Mail, Ticket, Gift, Film, Music, Calendar, LogOut } from 'lucide-react';
...
const Profile: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'My Profile - TixWix';
  }, []);
            ...
            <div className="lg:col-span-1">
              <div className="glass-card p-6 sticky top-24">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center text-3xl font-bold text-primary-foreground mb-4">
